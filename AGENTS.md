# iBolt Blog Generator - Codex Instructions
...
- **YouTube**: YouTube Data API v3 → `youtube-transcript` package → Codex extracts industry context
- **Reddit**: `reddit.com/r/{subreddit}/search.json` (public JSON API, no auth) → Codex extracts user language + pain points
- **Web**: Web fetch → Codex extracts industry context
